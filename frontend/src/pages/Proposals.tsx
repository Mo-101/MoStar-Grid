...
// [PLACEHOLDER_API_PROPOSALS] — replace with /api/proposals SSE/REST
const SEED: Proposal[] = [
  ...
  return (
    <main className="min-h-screen bg-background relative">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 py-10">
          ...
          {filtered.map((p) => (
            ...
            >
              ...
              <span className="flex items-center gap-2 truncate">
                <span className="text-lg">{p.element}</span>
        ...
        <p className="mt-6 text-[10px] font-mono uppercase tracking-[0.2em] text-muted-foreground">
