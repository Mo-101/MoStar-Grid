...
const LoadingHUD = ({ progress, status, voice, activeGlyph }: Props) => {
  ...
  return (
    <main className="fixed inset-0 bg-background text-foreground font-mono overflow-hidden">
        ...
        <div className="grid grid-cols-[1fr_auto_1fr] items-center gap-6 min-h-0">
          ...
          <div className="relative w-[clamp(220px,28vh,360px)] aspect-square">
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="text-7xl text-secondary drop-shadow-[0_0_24px_hsl(var(--secondary))] animate-pulse">
                {activeGlyph || "🜂"}
              </div>
            </div>
            <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
              <div className="grid grid-cols-3 gap-10 text-2xl opacity-60 translate-y-[5.5rem]">
                <span>🜄</span>
                <span />
                <span>🜃</span>
              </div>
