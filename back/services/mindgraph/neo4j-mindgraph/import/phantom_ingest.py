...
class PhantomIngestor:
    ...
    def _merge_epi_risk(tx, payload):
        query = """
        // 1. Ensure the Corridor exists — :Grid:Phantom namespace
        MERGE (c:CorridorNode {location: $location})
        SET c:Grid, c:Phantom
